...
import com.gang.app.data.MyMessageIntentService
import com.alibaba.sdk.android.push.notification.CPushMessage
import com.gang.app.common.utils.NotificationUtil
...
class MyMessageIntentService : AliyunMessageIntentService() {
    ...
    override fun onMessage(context: Context, cPushMessage: CPushMessage) {
        Log.i(TAG, "收到一条推送消息 ： " + cPushMessage.title + ", content:" + cPushMessage.content)
        buildNotification(context, cPushMessage)
    }
    ...
    companion object {
        private const val TAG = "MyMessageIntentService"
    }
}