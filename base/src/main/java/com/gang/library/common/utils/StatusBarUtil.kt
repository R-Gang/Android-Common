 ...
 * @Author:         haoruigang
 * @CreateDate:     2020/8/25 17:38
 * @UpdateUser:     更新者：
 * @UpdateDate:     2020/8/25 17:38
 * @UpdateRemark:   更新说明：
 * @Version:        1.0
 */
object StatusBarUtil {
    ...
    fun setColorDiff(activity: Activity, @ColorInt color: Int) {
        ...
        // 移除半透明矩形,以免叠加
        val fakeStatusBarView =
            contentView.findViewById<View>(FAKE_STATUS_BAR_VIEW_ID)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
...
// 添加 statusBarView 到布局中
        ...
        val fakeStatusBarView =
            contentLayout.findViewById<View>(FAKE_STATUS_BAR_VIEW_ID)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
     ...
     *
     * @param activity     需要设置的activity
     * @param drawerLayout DrawerLayout @IntRange(from = 0,to = 255)
     */
    fun setTranslucentForDrawerLayout(
    ...
    fun hideFakeStatusBarView(activity: Activity) {
        ...
        val fakeTranslucentView =
            decorView.findViewById<View>(FAKE_TRANSLUCENT_VIEW_ID)
     ...
     *
     * @param activity       需要设置的 activity
     * @param statusBarAlpha 透明值 @IntRange(from = 0,to = 255)
     */
