package com.gang.library.common.ext.oss
...
import com.gang.library.common.ext.oss.callback.ProgressCallback
...
class AliYunOss(context: Context?) {
    ...
    init {
        ...
        //        OSSLog.enableLog();
        oss = OSSClient(appContext, endpoint, credentialProvider, conf)
    }
}