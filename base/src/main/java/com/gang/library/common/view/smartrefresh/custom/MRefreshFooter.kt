package com.gang.library.common.view.smartrefresh.custom
...
class MRefreshFooter(context: Context?, @Nullable attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun t1(v: View, v2: View) {
        val holder = PropertyValuesHolder.ofFloat(TRANSLATION_X, 0f, dip2px(20f).toFloat(), 0f)
        val holder2 = PropertyValuesHolder.ofFloat(TRANSLATION_X, 0f, -dip2px(20f).toFloat(), 0f)
        val set = AnimatorSet()
